 ...
 <div class="content">
   <div class="container-fluid">
     <h1>Update Room</h1>
      ...
      <!-- HTML form for updating a room -->
      <form method="POST" action="?">
        <div class="form-group">
          <label for="hostel_id">Hostel ID:</label>
          <input type="text" name="hostel_id" class="form-control" value="<?php echo $room['hostel_id']; ?>" required>
        </div>
      ...
      <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          // Call the updateRoom function from operations.php
          $result = updateRoom($room_id, $hostel_id, $price);
