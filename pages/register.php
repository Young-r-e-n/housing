...
<head>
  ...
  <title>House Management Registration</title>
...
<div class="register-box">
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <!-- Update the form action to point to the PHP file that will handle signup -->
      <form action="../includes/process_admin_signup.php" method="post">

        <!-- Separate the first name and last name input fields -->
        ...
        <!-- Continue with the rest of the form as it is -->
