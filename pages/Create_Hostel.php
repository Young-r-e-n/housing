   ...
   <div class="content">
     <div class="container-fluid">
       <h1>Create Hostel</h1>
        ...
        <!-- HTML form for creating a hostel -->
        <form method="POST" action="?">
          <div class="form-group">
            <label for="landlord_id">Landlord ID:</label>
            <input type="text" name="landlord_id" class="form-control" required>
          </div>
        ...
        <?php
          ...
          if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            // Call the createHostel function from operations.php
            $result = createHostel($landlord_id, $hostel_name);
